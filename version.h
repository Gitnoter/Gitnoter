...
#define VER_PRODUCTVERSION_STR      "1.0.0.beta3"   // 产品版本
#define VER_PRODUCTBUILD_STR        131           // build
...
#define VER_FILEDESCRIPTION_STR     "Gitnoter for Windows Version 1.0.0.beta3 (build 131)"    // 文件说明
