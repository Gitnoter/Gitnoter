...
#define VER_FILEVERSION             1,0,0,5     //文件版本
#define VER_FILEVERSION_STR         "1.0.0.5"

#define VER_PRODUCTVERSION          1,0,0,4
#define VER_PRODUCTVERSION_STR      "1.0.0.beta5"   // 产品版本
#define VER_PRODUCTBUILD_STR        152           // build
...
#define VER_FILEDESCRIPTION_STR     "Gitnoter for Windows Version 1.0.0.beta5 (build 152)"    // 文件说明
