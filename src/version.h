...
#define VER_FILEVERSION             1,0,0,4     //文件版本
#define VER_FILEVERSION_STR         "1.0.0.4"

#define VER_PRODUCTVERSION          1,0,0,4
#define VER_PRODUCTVERSION_STR      "1.0.0.beta4"   // 产品版本
#define VER_PRODUCTBUILD_STR        140           // build
...
#define VER_FILEDESCRIPTION_STR     "Gitnoter for Windows Version 1.0.0.beta4 (build 140)"    // 文件说明
