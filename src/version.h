...
#define VER_FILEVERSION             1,0,0,6     //文件版本
#define VER_FILEVERSION_STR         "1.0.0.6"
...
#define VER_FILEDESCRIPTION_STR     "Gitnoter for Windows Version 1.0.0.beta6 (build 168)"    // 文件说明
